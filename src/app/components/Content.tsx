...
export default function Content() {
  return (
    <div className="bg-black py-8 px-4 sm:px-8 md:px-12 h-full w-full flex flex-col justify-end">
      <Section2 />
    </div>
  );
}
    ...
    <div className="flex flex-col justify-end items-start py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-36">
      ...
      <div className="w-full max-w-screen-xl mx-auto py-4 sm:py-6 md:py-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <ul className="flex flex-wrap items-center justify-center sm:justify-start gap-6 sm:gap-8 md:gap-10 text-xl sm:text-2xl mb-4 sm:mb-0 text-gray-500 dark:text-gray-400">
            <li>
              <a
